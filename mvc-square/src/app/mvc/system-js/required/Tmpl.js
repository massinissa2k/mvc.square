var Tmpl = function()
{
	...
	{
		_UTILS.loadFile( "text" , url , this.onLoadFile , { id : id , url : url , resolve : resolve , reject : reject } );
	};
		...
		return function( id_or_object , data , controllerClass , routeName , returnController )
		{
			...
			if( typeof( controllerClass ) === "function" )
			{
				...
				controller.__init__(
					echoElement
					,data
					,this.getHtmlNext.bind( this , id , data , echoElement , controller , routeName )
					);
