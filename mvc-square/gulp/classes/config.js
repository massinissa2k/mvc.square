...
[
	config.ARBO.src.appMvcLibJs
	,config.ARBO.src.systemJsStart
	,config.ARBO.src.systemJsRequired
	,config.ARBO.src.appMvcControllers
	,config.ARBO.src.appMvcModels
	,config.ARBO.src.appMvcConfigDir
	,config.ARBO.src.systemJsEnd
]
...
config.ARBO.dist.allTemplatesJst	= config.ARBO.dist.appMvcTemplates+"**/*+(.jst|.svg)"
